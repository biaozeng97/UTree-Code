...
setwd("C:/Unfolding Tree Model/ERS")
...
## 5. Run simulation 
Sim.ERSdata <- runSimulation(design = Design,
                                 replications =100,
                                 parallel = T ,
...
colnames(Sim.ERSdata) <- c(colnames(Sim.ERSdata)[1:4],
...
write.table(Sim.ERSdata,"sim_4models_ERSdata_final rep100_20240802.csv",row.names = F,sep = ",")
saveRDS(Sim.ERSdata,"Sim_4models_ERSdata_final rep100_20240802.rds")
save.image("Sim_4models_ERSdata_final rep100_20240802.Rdata")
